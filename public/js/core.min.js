...
!function (window, document, $) {
    ...
    $.site = $.site || {}, $.extend($.site, {
        _queue: {prepare: [], run: [], complete: []}, run: function () {
            var self = this;
            this.trigger("beforerun", this), this.dequeue("run", function () {
        ...
        if ("primary" === name && (name = $.configs.get("site", "primaryColor"), name || (name = "red")), "undefined" != typeof $.configs.colors[name]) {
