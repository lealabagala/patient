...
!function (window, document, $) {
    "use strict";
    var $body = ($(window), $(document), $(document.body));
    $.configs.set("site", {
        fontFamily: "RobotoDraft, sans-serif",
        primaryColor: "blue"
    }), window.Site = $.site.extend({
        run: function (next) {
            $("html").removeClass("before-run").addClass("after-run"), this.polyfillIEWidth(), $.site.menu.init(), $(".site-menubar").on("changing.site.menubar", function () {
                ...
                if ($target.hasClass("navbar-search-overlap"))$target.find("input").focus(), e.preventDefault(); else if ("site-navbar-collapse" === $target.attr("id")) {
                    ...
                    $body.toggleClass("site-navbar-collapse-show", isOpen), isOpen && $.site.menubar.scrollable.update()
                }
                ...
                $body.toggleClass("site-gridmenu-active", !active), active ? $this.removeClass("active").attr("aria-expanded", !1) : $this.addClass("active").attr("aria-expanded", !0)
            }), $.site.menubar.init(), Breakpoints.on("change", function () {
                $.site.menubar.change()
            }), $.site.sidebar.init(), $.site.footer.init(), $(document).tooltip({
                selector: "[data-tooltip=true]",
                container: "body"
            }), $('[data-toggle="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover(), $(document).on("click", '[data-toggle="fullscreen"]', function (e) {
            ...
            if ("undefined" == typeof this.tour) {
                ...
                this.tour = introJs(), this.tour.onbeforechange(function () {
                    ...
                    $("body").css("overflow", flag)
                }), this.tour.setOptions(tourOptions), $('[data-slug="advanced-tour"]').on("click", function () {
                    self.tour.start()
                })
            }
        }
