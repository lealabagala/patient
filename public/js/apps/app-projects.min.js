...
!function (document, window, $) {
    ...
    window.AppProjects = App.extend({
        handleSelective: function () {
            var members = [{id: "uid_1", name: "Member1", img: "../../../assets/portraits/1.jpg"}, {
                id: "uid_2",
                name: "Member2",
                img: "../../../assets/portraits/2.jpg"
            }, {id: "uid_3", name: "Member3", img: "../../../assets/portraits/3.jpg"}, {
                id: "uid_4",
                name: "Member4",
                img: "../../../assets/portraits/4.jpg"
            }], selected = [{id: "uid_1", name: "Member1", img: "../../../assets/portraits/1.jpg"}, {
                id: "uid_2",
                name: "Member2",
                img: "../../../assets/portraits/2.jpg"
            }];
