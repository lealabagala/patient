...
!function (document, window, $) {
    ...
    window.AppProjects = App.extend({
        handleSelective: function () {
            var members = [{id: "uid_1", name: "Herman Beck", img: "../../../assets/portraits/1.jpg"}, {
                id: "uid_2",
                name: "Mary Adams",
                img: "../../../assets/portraits/2.jpg"
            }, {id: "uid_3", name: "Caleb Richards", img: "../../../assets/portraits/3.jpg"}, {
                id: "uid_4",
                name: "June Lane",
                img: "../../../assets/portraits/4.jpg"
            }], selected = [{id: "uid_1", name: "Herman Beck", img: "../../../assets/portraits/1.jpg"}, {
                id: "uid_2",
                name: "Caleb Richards",
                img: "../../../assets/portraits/2.jpg"
            }];
