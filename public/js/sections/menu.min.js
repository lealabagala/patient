...
!function (window, document, $) {
    "use strict";
    $.site.menu = {
        speed: 250, accordion: !0, init: function () {
            this.$instance = $(".site-menu"), this.bind()
        }, bind: function () {
            var self = this;
            this.$instance.on("mouseenter.site.menu", ".site-menu-item", function () {
                if ($.site.menubar.folded === !0 && $(this).is(".has-sub")) {
                ...
                $(this).is(".has-sub") ? (e.preventDefault(), $(this).is(".open") ? $(this).trigger("close.site.menu") : $(this).trigger("open.site.menu")) : $(this).is(".active") || ($(this).siblings(".active").trigger("deactive.site.menu"), $(this).trigger("active.site.menu")), e.stopPropagation()
            })
        }, collapse: function ($item, callback) {
            var self = this, $sub = $item.children(".site-menu-sub");
            ...
            var self = this, $sub = $item.children(".site-menu-sub"), $children = $sub.children(".site-menu-item").addClass("is-hidden");
            ...
            var offsetTop = $item.position().top, dropdownHeight = $dropdown.outerHeight(), menubarHeight = $(".site-menubar").outerHeight();
            offsetTop + dropdownHeight > menubarHeight && offsetTop > menubarHeight / 2 ? $dropdown.addClass("site-menu-sub-up") : $dropdown.removeClass("site-menu-sub-up")
        }
    }
